...
const ContentBox = ({ title, borderColor, showFlashes, showLoadingOverlay, children, ...props }: Props) => (
    <div {...props}>
        ...
        {showFlashes && (<FlashMessageRender byKey={typeof showFlashes === 'string' ? showFlashes : undefined} css={tw`mb-4`} />)}
        <div css={[tw`bg-secondary p-4 rounded shadow-lg relative`, !!borderColor && tw`border-t-4`]}>
